...
The objective of this lab was to simulate real-world Tier 1 SOC investigations, focusing on authentication monitoring, process analysis, privilege escalation detection, and incident classification within a controlled environment.
...
- **Network:** Isolated private lab (RFC1918 – 192.168.x.x range)

---

## Key Windows Security Event IDs Analysed
...
- Event Correlation & Logon ID Tracking  
...
- Supporting event evidence (screenshots)
